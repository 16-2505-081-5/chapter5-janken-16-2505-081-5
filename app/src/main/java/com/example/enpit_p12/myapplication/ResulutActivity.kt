...
import kotlinx.android.synthetic.main.activity_resulut.*

class ResulutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_resulut)
    ...
    private fun saveData(myHand: Int ,comHand:Int, gameResult: Int){
        ...
        val winningStreakCount = pref.getInt("WINNING_STREAK_CPUNT",0)
